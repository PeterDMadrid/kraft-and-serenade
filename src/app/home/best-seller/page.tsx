    ...
    return (
        <div className={`${poppins.className} mt-12 p-8 text-white text-xs sm:text-sm w-full bg-neutral-900`}>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-5xl mx-auto">
                ...
                <div className="flex flex-col justify-between sm:justify-normal gap-6 p-6 min-h-80">
                    <h2 className="text-4xl font-bold">This Month's Best Seller</h2>
                    ...
                    <a className="border border-white hover:bg-white hover:text-black transition-colors cursor-pointer py-6 px-12 text-[1.1rem] w-fit">
                        Learn More
                    </a>
                </div>
            </div>
